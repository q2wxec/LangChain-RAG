 ...
 * @FilePath: /LangChain-RAG-open-source/src/components/OptionList.vue
 * @Description: 
-->
<template>
  <div class="list-page">
    <div class="content">
      <div class="options">
        ...
        <div class="add-link" @click="showPromptModal">设置提示词</div>
        <div class="add-link" @click="showQaFileUpload">上传文档Qa</div>
      </div>
      <div class="table">
...
const showPromptModal = () => {
  ...
  setModalTitle('自定义提示词');
};

const showQaFileUpload = () => {
  setQaModalVisible(true);
  setQaModalTitle('上传文档Qa');
};
