...
app.add_route(set_prompt, "/api/local_doc_qa/set_prompt", methods=['POST'])  # tags=["提示词设置"] 
app.add_route(get_prompt, "/api/local_doc_qa/get_prompt", methods=['POST'])  # tags=["提示词获取"] 

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DIST_DIR = os.path.join(BASE_DIR, 'web_ui/dist/LangChain-RAG')
print("DIST_DIR：",DIST_DIR)
app.static("/LangChain-RAG", DIST_DIR)
